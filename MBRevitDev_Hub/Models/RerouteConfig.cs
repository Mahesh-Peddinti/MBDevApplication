namespace MBRevitDev_Hub.Models
{
    public class RerouteConfig
    {
        ...
        /// 10 mm = 0.0328084 ft
        /// </summary>
        public double MinFittingGapFeet { get; set; } = 75.0 / 304.8;
        ...
        public double TransitionRunFeet { get; set; } = 100.0 / 304.8; // 200mm transition run
    }
}
